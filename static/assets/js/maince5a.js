...
$(function () {
  ...
  $('.floated-colors-btn').on('click', function () {
    if ($('body').hasClass('color-scheme-dark')) {
      ...
      $('.menu-w').addClass('color-scheme-dark').addClass('color-style-dark').removeClass('selected-menu-color-light').addClass('selected-menu-color-bright');
      $('.top-bar').addClass('color-scheme-dark');
